    ...
    data = [
        {
            ...
            "restaurant_name": "Evos",
            "promo_title": "Lavash Meat",
            "current_price": 30000,
            "original_price": 35000,
            "restaurant_reviews": 5000,
            "discount_percent": 14.3,
        },
        {
            "platform": "Yandex Eda",
            "restaurant_name": "Oqtepa Lavash",
            "promo_title": "Lavash Meat",
            "current_price": 25000,
            "original_price": 30000,
            "restaurant_reviews": 3000,
            "discount_percent": 16.7,
        },
        {
            "platform": "Uzum Tezkor",
            "restaurant_name": "MaxWay",
            "promo_title": "Cheese Burger",
            "current_price": 35000,
            "original_price": 40000,
            "restaurant_reviews": 8000,
            "discount_percent": 12.5,
        },
        {
            "platform": "Yandex Eda",
            "restaurant_name": "FeedUp",
            "promo_title": "Cheese Burger",
            "current_price": 28000,
            "original_price": 35000,
            "restaurant_reviews": 1200,
            "discount_percent": 20,
        },
        {
            "platform": "Uzum Tezkor",
            "restaurant_name": "Safia",
            "promo_title": "Honey Cake",
            "current_price": 40000,
            "original_price": 50000,
            "restaurant_reviews": 10000,
            "discount_percent": 20,
        },
    ]
...
with col1:
    st.markdown(
        '<div class="glass-card"><div class="metric-label">Active Promos</div><div class="metric-value">1,248</div></div>',
        unsafe_allow_html=True,
    )
with col2:
    st.markdown(
        '<div class="glass-card"><div class="metric-label">Avg Discount</div><div class="metric-value" style="background: linear-gradient(90deg, #F43F5E, #EC4899); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">18.5%</div></div>',
        unsafe_allow_html=True,
    )

tab1, tab2, tab3, tab4 = st.tabs(
    ["Top Discounts", "Product Search", "Market Overview", "Price Anomalies"]
)
...
with tab2:
    ...
    search_query = st.text_input(
        "Enter product name (e.g., 'Lavash', 'Burger', 'Sushi')"
    )
    if search_query:
...
with tab3:
    ...
    category_counts = (
        df.groupby(["category", "platform"]).size().reset_index(name="count")
    )
    fig = px.bar(
        category_counts, x="category", y="count", color="platform", barmode="group"
    )
    fig.update_layout(
...
with tab4:
    ...
    st.markdown(
        "<p style='color:#94A3B8;'>Dishes that are more expensive but get bought more frequently due to brand trust.</p>",
        unsafe_allow_html=True,
    )
