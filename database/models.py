...
class Restaurant(Base):
    ...
    snapshots = relationship("PriceSnapshot", back_populates="restaurant", cascade="all, delete-orphan")
...
class Promotion(Base):
    ...
    # Promo Constraints
    promo_type = Column(String, default="standard") # 'discount', 'free_delivery', '1+1', 'standard' (no promo)
