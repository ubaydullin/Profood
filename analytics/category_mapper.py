...
CATEGORY_MAP: Dict[str, List[str]] = {
    "Fast Food": ["evos", "oqtepa lavash", "maxway", "kfc", "feedup", "loook", "bellissimo", "burger"],
    "National Cuisine": ["rayhon", "kamolon", "besh qozon", "milliy", "shashlik", "plov", "somsa"],
    "Sushi & Pan-Asian": ["yapona mama", "sushi", "wasabi", "chopsticks", "wok"],
    "Pizza": ["bellissimo", "chopar", "dominos", "pizza", "papa johns"],
    "Coffee & Desserts": ["safia", "chaiqof", "b&b", "black bear", "pie republic", "cake", "coffee"]
}

# Ignore list for non-food stores
IGNORE_KEYWORDS: List[str] = [
    "аптека", "apteka", "pharmacy", "dorixona",
    "цветы", "flowers", "gullar", "cvety",
    "зоомагазин", "zoo", "pet shop",
